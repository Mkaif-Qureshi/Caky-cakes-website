<?php include('partials-front\menu.php'); ?>
    ...
    <section class="categories">
        <div class="container">
            ...
            <?php
                //query to diaplay the categories
                $sql = "SELECT * FROM t_category WHERE active='Yes' AND fetured='Yes' LIMIT 3";
                        ...
                        <div class="box-3 float-container">
                            <?php
                                if($image_name==""){
                                    ...
                                    ?>
                                    <img src="<?php echo HOMEURL;?>img/category/<?php echo $image_name?>.jpg" alt="BIRTHDAY" class="img-responsive img-curve">
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php
                $sql2 = "SELECT * FROM t_cake WHERE active='Yes' AND featured='Yes' LIMIT 6";
                ...
                if($count2>0){
                    ...
                    echo "<div class='error'>NO Item</div>";
                }
